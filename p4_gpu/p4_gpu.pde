...
void draw() {
  ...
  for (int x = 0; x < 60; x++) {
    for (int y = 0; y < 60; y++) {
      ...
      vertex(x * 300.0 / 60.0, y * 300.0 / 60.0, 0, x / 60.0, y / 60.0);
      vertex((x + 1) * 300.0 / 60.0, y * 300.0 / 60.0, 0, (x + 1) / 60.0, y / 60.0);
      vertex((x + 1) * 300.0 / 60.0, (y + 1) * 300.0 / 60.0, 0, (x + 1) / 60.0, (y + 1) / 60.0);
      vertex(x * 300.0 / 60.0, (y + 1) * 300.0 / 60.0, 0, x / 60.0, (y + 1) / 60.0);
      endShape();
    }
  }
  popMatrix();
